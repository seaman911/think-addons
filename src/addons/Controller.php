...
class Controller extends \think\Controller
{
    ...
    public function __construct($app = null)    
    {
        ...
        $this->addonmodule = $convert ? strtolower(array_pop($route)) : array_pop($route);
        $this->addon = $convert ? strtolower(array_pop($route)) : array_pop($route);

        // 生成view_path
        if($this->addonmodule){
            $view_path = Env::get('addons_path') . $this->addon . DIRECTORY_SEPARATOR . $this->addonmodule .  DIRECTORY_SEPARATOR . 'view' . DIRECTORY_SEPARATOR;
        }else{
